...
namespace AlphaFacev2.Controllers
{
    public class HistoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Username,Password,LoginTime,IsLoginSuccess,IpAddress")] History history)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Username,Password,LoginTime,IsLoginSuccess,IpAddress")] History history)
        {
            if (id != history.Id)
            {
                return NotFound();
